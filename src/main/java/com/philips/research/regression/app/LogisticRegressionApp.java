...
//        LogisticRegressionDummy frescoApp = new LogisticRegressionDummy(myId, m, v, lambda,
//            iterations, privacyBudget, sensitivity);
        LogisticRegression frescoApp = new LogisticRegression(myId, m, v, lambda,
            iterations, privacyBudget, sensitivity);
